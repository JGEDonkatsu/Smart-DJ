...
class CapNUp(QThread):
            ...
            try:
                ...
                if not nested.empty():
                    for x1, y1, x2, y2 in rects:
                        ...
                        cv2.imwrite('uploader/{0}.jpg'.format(self.fileNum), zoom)
                        print "OK"
    ...
    def UploadToS3(self):
        ...
        self.S3.put_object(ACL = 'public-read', Bucket = 'dgutest01', Key = self.today+'/'+self.fileName+'/'+'Weather.xls', Body = wData)
        wData.close()
        self.counter = 0
